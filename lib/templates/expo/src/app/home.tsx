                    ...
                    <View className="flex flex-col items-center gap-4 text-center">
                        ...
                        <View className="gap-4">
                            <Link
                                ...
                                className="flex items-center justify-center px-4 py-2 overflow-hidden text-sm font-medium transition-colors bg-gray-900 rounded-md h-9 text-gray-50 web:shadow ios:shadow hover:bg-gray-900/90 active:bg-gray-400/90 web:focus-visible:outline-none web:focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 dark:hover:bg-gray-50/90 dark:focus-visible:ring-gray-300"
                                href="/"
                            >
                                Return
                            </Link>
    ...
    return (
        <View style={{ paddingTop: top }}>
            <View className="flex flex-row items-center justify-between px-4 lg:px-6 h-14 ">
                <Link
                    className="items-center justify-center flex-1 font-bold"
                    href="/"
                >
                    ACME
                </Link>
